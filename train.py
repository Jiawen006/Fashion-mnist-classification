...
if __name__ == "__main__":
    ...
    # train resnet50
    model = train_model(model='ResNet', lr=args.lr, train_loader=train_loader, validation_loader=validation_loader,
                        test_loader=test_loader, train_eps=0.15, test_eps=0.05, adversarial=False)
    # # train 2 layer cnn
    # model = train_model(model='cnn2', lr=args.lr, train_loader=train_loader, validation_loader=validation_loader,
    #                     test_loader=test_loader, train_eps=0.15, test_eps=0.05, adversarial=False)
    # # train 4 layer cnn
    # model = train_model(model='cnn4', lr=args.lr, train_loader=train_loader, validation_loader=validation_loader,
    #                     test_loader=test_loader, train_eps=0.15, test_eps=0.05, adversarial=False)
